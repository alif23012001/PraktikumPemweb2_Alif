...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            $pasien = ['kodePasien' => $pasien_object->getpropertis('pasien')->getpropertis('kodePasien'), 'tanggal' => $pasien_object->getpropertis('tglChecked'), 'nama' => $pasien_object->getpropertis('pasien')->getpropertis('namaPasien'), 'jk' => $pasien_object->getpropertis('pasien')->getpropertis('gender'), 'bb' => $pasien_object->getpropertis('bmi')->getpropertis('berat'), 'tb' => $pasien_object->getpropertis('bmi')->getpropertis('tinggi'), 'bmi' => $pasien_object->getpropertis('bmi')->getNilaiBMI(), 'status' =>  $pasien_object->getpropertis('bmi')->getStatusBMI(), 'image' => $pasien_object->getpropertis('bmi')->getImageByNilaiBMI()];
